...
public final class Downloads implements BaseColumns {
     ...
     */
    public static final String AUTHORITY = "landlord.guardts.house.download";
     ...
     * @hide
     */
    public static final String PERMISSION_ACCESS = "landlord.guardts.house.download.permission.ACCESS_DOWNLOAD_MANAGER";
     ...
     * @hide
     */
    public static final String PERMISSION_ACCESS_ADVANCED = "landlord.guardts.house.download.permission.ACCESS_DOWNLOAD_MANAGER_ADVANCED";

    /**
     * The permission to access the all the downloads in the manager.
     */
    public static final String PERMISSION_ACCESS_ALL = "landlord.guardts.house.download.permission.ACCESS_ALL_DOWNLOADS";
     ...
     * @hide
     */
    public static final String PERMISSION_SEND_INTENTS = "landlord.guardts.house.download.permission.SEND_DOWNLOAD_COMPLETED_INTENTS";

    /**
     * The permission to download files without any system notification being
     * shown.
     */
    public static final String PERMISSION_NO_NOTIFICATION = "landlord.guardts.house.download.permission.DOWNLOAD_WITHOUT_NOTIFICATION";
     ...
     * landlord.guardts.house.download.permission.ACCESS_DOWNLOAD_MANAGER_ADVANCED.
     * <P>
     * Type: INTEGER
     * </P>
     * <P>
